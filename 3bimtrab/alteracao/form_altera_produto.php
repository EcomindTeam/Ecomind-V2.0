        ...
        <div id="mãe">
            ...
            <div id="principal">
                ...
                <form class="box" action="grava_produto_alterado.php" method="post">
                    ...
                    Código do produto <input type="number" name="idproduto" value="<?php echo $linha['idproduto']; ?>" readonly>
                    Nome <input type="text" name="nome" value="<?php echo $linha['nome']; ?>">
                    Preço <input type="number" name="precoproduto" step="0.01" value="<?php echo $linha['precoproduto']; ?>">
                    Descrição <input type="text" name="descricaoproduto" value="<?php echo $linha['descricaoproduto']; ?>">
                    Quantidade em estoque <input type="number" name="qtdeestoque" value="<?php echo $linha['qtdeestoque']; ?>"><br>
