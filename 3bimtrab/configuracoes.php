    ...
    <center>
        <div id="mãe">
            ...
            <div id="principal">
                <div id="conf">
                    <h3>Inserção</h3>
                    <a class="zero" href="/Ecomind-V2.0/3bimtrab/insercao/form_insere_produto.php"> Inserir Produto </a><br><br><br>
                    <h3>Alteração</h3>
                    <a class="zero" href="/Ecomind-V2.0/3bimtrab/alteracao/altera_produto.php"> Alterar Produto </a><br><br><br>
                    <a class="zero" href="/Ecomind-V2.0/3bimtrab/alteracao/altera_usuario.php"> Alterar Usuário </a><br><br><br>
                    <h3>Exclusão</h3>
                    <a class="zero" href="/Ecomind-V2.0/3bimtrab/exclusao/exclui_produto.php"> Excluir Produto </a><br><br><br>
                    <a class="zero" href="/Ecomind-V2.0/3bimtrab/exclusao/exclui_usuario.php"> Excluir Usuário </a><br><br><br>
                </div>
            </div>
