	...
	<center>
		<div id="mãe">
			<div id="topo">
				...
				<div id="botoes">&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="/Ecomind-V2.0/3bimtrab/login.php"> <img src="/Ecomind-V2.0/3bimtrab/imagens/usuario.png" width="3%"></a> &nbsp;&nbsp;
					...
					<a class="zero" href="/Ecomind-V2.0/3bimtrab/design.html"> Design </a> &nbsp;&nbsp;
					<a class="zero" href="/Ecomind-V2.0/3bimtrab/cadastro.php"> Cadastro </a> &nbsp;&nbsp;
					<a class="zero" href="/Ecomind-V2.0/3bimtrab/estatisticas.html"> Estatísticas </a> &nbsp;&nbsp;
					<a href="/Ecomind-V2.0/3bimtrab/carrinho/carrinho.php"> <img src="/Ecomind-V2.0/3bimtrab/imagens/carrinho.png" width="3.5%"></a> &nbsp;&nbsp;
					<a href="/Ecomind-V2.0/3bimtrab/configuracoes.html"> <img src="/Ecomind-V2.0/3bimtrab/imagens/engrenagem.png" width="3.5%"></a> &nbsp;&nbsp;
					<br>
				</div>
				<a name="topo"></a> &nbsp;&nbsp;
			...
			<table>
				...
				<form action="?acao=voltar" method="post">
					<tfoot>
						<tr>
							<td colspan="5"><a href="/Ecomind-V2.0/3bimtrab/carrinho/carrinho.php">Voltar</a></td>
					</tfoot>
					...
					<tbody>
						...
						if (count($_SESSION['carrinho']) == 0) {
							...
							//if ($res <= 0){1
							foreach ($_SESSION['carrinho'] as $idproduto => $qtd) { // Início do FOREACH
			...
			<div id="rodape">
				<center>
					...
					<a class="um" href="design.html"> Design </a> &nbsp;&nbsp;
					<a class="um" href="cadastro.php"> Cadastro </a> &nbsp;&nbsp;
					<a class="um" href="estatisticas.html"> Estatísticas </a> &nbsp;&nbsp;
					<br><br>
