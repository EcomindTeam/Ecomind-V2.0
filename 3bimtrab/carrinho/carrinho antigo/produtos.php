    ...
    <center>
        <div id="mãe">
            <div id="topo">
                ...
                <div id="botoes">&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="/Ecomind-V2.0/3bimtrab/login/login.php"> <img src="/Ecomind-V2.0/3bimtrab/imagens/usuario.png" width="3%"></a> &nbsp;&nbsp;
            ...
            if ($qtdeestoque > 0)
                while ($linha = pg_fetch_array($res)) {
                    ...
                    echo "<a href='/Ecomind-V2.0/3bimtrab/carrinho/carrinho.php?acao=add&idproduto=" . $linha['idproduto'] . "'>Comprar</a>";
                    echo "</div>";
                    echo "<br />";
                }
            else
            ...
            <div id="rodape">
                <center>
                    ...
                    <a class="um" href="/Ecomind-V2.0/3bimtrab/design.html"> Design </a> &nbsp;&nbsp;
                    <a class="um" href="/Ecomind-V2.0/3bimtrab/insercao/cadastro.php"> Cadastro </a> &nbsp;&nbsp;
                    <a class="um" href="/Ecomind-V2.0/3bimtrab/estatisticas.html"> Estatísticas </a> &nbsp;&nbsp;
                    <br><br>
