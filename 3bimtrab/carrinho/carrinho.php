...
{
   echo "<meta HTTP-EQUIV='refresh' CONTENT='0;URL=/Ecomind-V2.0/3bimtrab/login/login.php'>";
   exit; // SAI     
}
      ...
      <div id="mãe">
         ...
         <div id="topo">
            ...
            if ($_SESSION["adm"] == true) {
               echo "<a class='topo' href='usuarios.php'>USUARIOS</a>&nbsp;&nbsp;";
            }
            ?>
            <a name="topo"></a> &nbsp;&nbsp;
            <h1>Carrinho</h1>
         ...
         <div id="principal">
            ...
            <form class="box" action="?acao=up" method="post">
               ...
               <a class="dois" href="/Ecomind-V2.0/3bimtrab/carrinho/produtos.php">Continuar Comprando</a><br><br>
               <a class="dois" href="/Ecomind-V2.0/3bimtrab/carrinho/finalizacompra.php">Finalizar Compra</a><br><br>
            </form>
         </div>
