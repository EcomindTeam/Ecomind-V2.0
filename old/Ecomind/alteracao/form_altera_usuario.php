        ...
        <div id="mãe">
            ...
            <div id="principal">
                ...
                <form class="box" action="grava_usuario_alterado.php" method="post">
                    ID do Usuário <input type="number" name="idusuario" value="<?php echo $linha[idusuario]; ?>" readonly>
                    Nome <input type="text" name="nome" value="<?php echo $linha[nome]; ?>">
                    Senha <input type="text" name="senha" value="<?php echo $linha[senha]; ?>">
                    CPF <input type="text" name="cpf" value="<?php echo $linha[cpf]; ?>">
