    ...
    <center>
        <div id="mãe">
            ...
            <div id="principal">
                ...
                <div id="text_image1">
                    <div id="interna1">
                        <img src="/Ecomind-V2.0/3bimtrab/imagens/copo.jpg" width="80%">
                    </div><br>
                    <div id="interna2">
                ...
                <div id="text_image2">
                    <div id="interna1">
                        <img src="/Ecomind-V2.0/3bimtrab/imagens/escova.jpg" width="80%">
                    </div><br>
                    <div id="interna2">
                ...
                <div id="text_image3">
                    <div id="interna1">
                        <img src="/Ecomind-V2.0/3bimtrab/imagens/escovadentes.jpg" width="80%">
                    </div><br>
                    <div id="interna2">
